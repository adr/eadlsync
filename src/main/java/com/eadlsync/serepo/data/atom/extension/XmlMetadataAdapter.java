package com.eadlsync.serepo.data.atom.extension;
 ...
 * {@link Metadata} holds a list with
 * {@link Metadata.Entry} entries.
 * 
 */
public class XmlMetadataAdapter extends XmlAdapter<XmlMetadataAdapter.Metadata, Map<String, Object>> {

	/**
	 * Class which holds all metadata entries {@link Entry}.
	 *
	 */
